...
public class Scania extends TruckI {
    ...
    public static class CarView extends JFrame {
        private static final int X = 800;
        private static final int Y = 800;

        // The controller member
        CarController carC;
        Position.DrawPanel drawPanel;// = new Position.DrawPanel(carC, X, Y-240);
        ...
        public CarView(String frameName, CarController cc){
            this.carC = cc;
            this.drawPanel = new Position.DrawPanel(cc, X, Y-240);
